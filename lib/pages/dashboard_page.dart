...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) => AppLayout(
    selectedIndex: 0, // Dashboard es índice 0
      ...
      Container(
        ...
        child: Row(children: [
          Expanded(child: Column(
            ...
            children: [
              Text('Bienvenido${_nombre.isNotEmpty ? ', $_nombre' : ''}',
                style: const TextStyle(color: Colors.white,
                    fontSize: 17, fontWeight: FontWeight.bold)),
              if (_rol.isNotEmpty)
                Text(_rol.toUpperCase(),
            ...
            child: Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    _statCard('Bancas',   '${_stats['bancas_total'] ?? 0}',
                        Icons.storefront_outlined, Colors.blue),
                    _statCard('Activas',  '${_stats['bancas_activas'] ?? 0}',
                        Icons.check_circle_outline, Colors.green),
                    _statCard('Usuarios', '${_stats['usuarios_total'] ?? 0}',
                        Icons.people_outline, Colors.purple),
                    _statCard('Vendedores','${_stats['vendedores'] ?? 0}',
  ...
  Widget _seccion(String label) => Text(label,
  ...
  Widget _accesoRapido(BuildContext context, String label,
      IconData icon, String ruta, Color color) =>
    InkWell(
